            ...
            @section('mainContent')
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        var calendar = new FullCalendar.Calendar(calendarEl, {
                            ...
                            eventContent: function(arg) {
                                ...
                                if (start && end) {
                                    ...
                                    //     var calendarWrapper = calendarEl.querySelector('.fc-scrollgrid');
                                    //     calendarWrapper.addEventListener('scroll', function() {
                                    //         if (calendarWrapper.scrollTop + calendarWrapper
                                    //             .clientHeight >= calendarWrapper.scrollHeight) {
                                    //             if (calendar.view.type === 'dayGridMonth') {
                                    //                 calendar.next(); // Next month for month view
                                    //             } else if (calendar.view.type === 'timeGridWeek') {
                                    //                 calendar.next(); // Next week for week view
                                    //             }
                                    //         }
                                    //     });
                                    // }
                        ...
                        // var calendarScrollEl = calendarEl.getElementsByClassName('fc-scrollgrid')[0];
                        // calendarScrollEl.addEventListener('scroll', function() {
                        //     var scrollTop = calendarScrollEl.scrollTop;
                        //     var scrollHeight = calendarScrollEl.scrollHeight - calendarScrollEl.clientHeight;

                        //     // Detect when the user reaches the bottom of the scroll container
                        //     if (scrollTop >= scrollHeight) {
                        //         // Navigate to the next time period (e.g., next month)
                        //         calendar.next();
                        //         calendar.render();
                        //         calendarScrollEl.scrollTop = 0; // Reset the scroll position to the top
                        //     }
                        // });
